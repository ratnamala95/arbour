...
<form method="post" id="cartform">
    ...
    <input type="hidden" name="cart_pro_code" value="<?= $productResults['code']; ?>">
     <input type="hidden" name="cart_inventory_id" value="<?= $productResults['inventory_id']; ?>">
				...
				<div class="details col-md-8">
					<div class="row">
						...
						<div class="col-md-6">
							...
							<table class="col-lg-6 table table-responsive set_qty_table" style="margin-left: -10px;">
							  	<thead>
							    	<tr>
									...
									<?php
								    	...
								    	foreach ($rowattrdata as $rowattrresults) {
						                    ...
						                    $availableSet=$totalPieces/$piecesPerSet;
						                    	...
						                    	$stockAvilableSet = number_format((int)$availableSet);
								    ...
								    <input type="hidden" placeholder="size" class="productsize" name="cart_pro_size[]" value="<?php echo $rowattrresults['id']; ?>" >
								    	<tr>
									      	<td style="text-align: center;" >
									      		<?php echo $rowattrresults['name'];  ?>

									      	</td>
									      	<td style="text-align: left;">
									      		<?php
									      			if (isset($stockAvilableSet) && $stockAvilableSet>0) {
									      				if(isset($stockAvilableSet) && $stockAvilableSet>=1 && $stockAvilableSet<=5)
									      				{
									      					echo '<span class="out-of-stock" style="color:rgb(254,145,38);">Limited Stock</span>';
									      				}
									      			} else {
									      				echo '<span class="out-of-stock"><strong>Out of Stock</strong></span>';
									      			}
