...
<div class="products">
  ...
  <div class="container">
    <p >
      <h3 style="margin-bottom: 2em;"> Upcomming Products </h3>
    </p>
    <div class="row">
      ...
      <div class="col-md-12 products-right">
        ...
        <?php
          //print_r($upcommingproducts);


            $count=0;
            foreach ($upcommingproducts as $productListResults) {
             ++$count;
    ...
    <?php
      if (count($upcommingproducts)%4!=0) {
        echo '<div class="clearfix"> </div></div>';
      }
    ?>
