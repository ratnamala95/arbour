...
class Placeorder extends Backend_Controller {
	...
	public function order() 	
	{
		...
		if (!empty($this->input->post())) {
            ...
            // Genertae transaction id
			
			$wareHouseCount= $this->Dbaction->getSingleData('users','user_count',['id'=>$orderdata['wrehouse_id']]);
			...
			$distributoreCount= $this->Dbaction->getSingleData('users','user_count',['id'=>$orderdata['distributor_id']]);
			...
			$retailerCount= $this->Dbaction->getSingleData('users','user_count',['id'=>$orderdata['customers_id']]);
